  ...
  return (
    <MobileSectionShell id="coleccion" titleId="mobile-coleccion-title" ariaLabel="Colección" className="py-14 sm:py-16">
      ...
      <div className="mt-10 overflow-hidden border-l-2 border-clay/35 pl-5">
        ...
        <h3 className="mt-2 font-display text-3xl leading-none tracking-[0.035em] text-primary sm:text-4xl">{featured.title}</h3>
        <p className="mt-3 text-base leading-7 text-secondary/72">{featured.copy}</p>
      </div>
      <div className="mt-10 space-y-7">
        <div className="border-l-2 border-clay/25 pl-5">
          <p className="text-sm font-semibold text-clay">{tray.label}</p>
          <h3 className="mt-2 text-xl font-semibold tracking-[-0.02em] text-primary sm:text-2xl">{tray.title}</h3>
          <p className="mt-2 text-base leading-7 text-secondary/72">{tray.copy}</p>
        </div>
        <div className="border-l-2 border-clay/25 pl-5">
          <p className="text-sm font-semibold text-clay">{taps.label}</p>
          <h3 className="mt-2 text-xl font-semibold tracking-[-0.02em] text-primary sm:text-2xl">{taps.title}</h3>
