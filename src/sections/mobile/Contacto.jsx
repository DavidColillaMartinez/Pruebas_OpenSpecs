      ...
      <section id="contacto" aria-labelledby="mobile-contacto-title" className="bg-transparent px-5 py-16 sm:px-6">
        <div className="mx-auto max-w-lg">
          ...
          <div className="mt-4 space-y-3">
            <a href={`https://wa.me/${PHONE_INTL}`} className="group flex items-center gap-4 rounded-2xl border border-ink/8 bg-white/78 p-4 text-ink shadow-soft transition hover:-translate-y-0.5">
              <span className="grid h-10 w-10 place-items-center rounded-full bg-[#25D366]/15 text-[#25D366]"><ContactIcon channel="whatsapp" className="h-6 w-6" /></span>
            ...
            <a href={`tel:+34${PHONE}`} className="group flex items-center gap-4 rounded-2xl border border-ink/8 bg-white/78 p-4 text-ink shadow-soft transition hover:-translate-y-0.5">
              <span className="grid h-10 w-10 place-items-center rounded-full bg-ink/8 text-ink/65"><ContactIcon channel="phone" className="h-6 w-6" /></span>
            ...
            <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 rounded-2xl border border-ink/8 bg-white/78 p-4 text-ink shadow-soft transition hover:-translate-y-0.5">
              <span className="grid h-10 w-10 place-items-center rounded-full bg-clay/12 text-clay"><ContactIcon channel="instagram" className="h-6 w-6" /></span>
