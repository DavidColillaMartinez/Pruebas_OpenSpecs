  ...
  return (
    <section id="inicio" aria-labelledby="mobile-inicio-title" className="relative flex min-h-svh flex-col items-center justify-center overflow-hidden bg-surface-elevated px-6 pt-24 pb-16 sm:pt-32">
      <div className="relative z-10 mx-auto flex w-full max-w-2xl flex-col items-center text-center">
        ...
        <p className="mt-6 max-w-md text-base leading-7 text-secondary/72 sm:text-lg sm:leading-8">Baños, materiales y decisiones visuales con medida. Mamparas a medida, platos minerales, grifería premium y accesorios.</p>
