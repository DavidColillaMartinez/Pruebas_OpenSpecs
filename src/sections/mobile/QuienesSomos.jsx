...
export function MobileQuienesSomos() {
  return (
    <MobileSectionShell id="quienes-somos" titleId="mobile-quienes-somos-title" ariaLabel="Quiénes somos" className="py-14 sm:py-16">
      <h2 id="mobile-quienes-somos-title" className="font-display text-4xl leading-[1.02] tracking-[0.035em] text-ink sm:text-5xl text-wrap-balance">Qué hay detrás de cada baño.</h2>
      <p className="mt-4 text-base leading-7 text-ink/72 sm:text-lg sm:leading-8">Un estudio que mide, compone y prepara antes de instalar.</p>
