...
export const googleReviews = [
  review('fer-diaz', 'Fer diaz', 'Hace un mes', 'Los recomiendo, sin dudarlo. Buen precio, profesionalidad, asesoramiento y diálogo. Sin duda, mi casa estaba completamente disfuncional por los años y ahora siento que es lo mejor que pude hacer. No dude en recomendarlo a familiares y amigos.', 'fer-diaz.jpg'),
  review('francisco-javier-morales-de-la-torre', 'Francisco Javier Morales De La Torre', 'Hace un mes', 'Me han hecho una reforma completa de la casa y la verdad no puedo estar mas satisfecho. Excelentes profesionales, desde Lucia en tienda, asesorando y dando soluciones, hasta Roberto, a pie de obra, y resto de profesionales que han trabajado en ella. 100% recomendables.', 'francisco-javier-morales-de-la-torre.jpg'),
  review('faly-zarza', 'Faly Zarza', 'Hace un mes', 'Hola recomendables 100 x 100 todos ellos, Loren Lucia Rober y todo el personal, me han hecho dos reformas, profesionales y responsables todos, el trato maravilloso y con mucha educación de precio fabuloso para nosotros como familia sin duda contaremos con ellos para nuestras próximas reformas, gracias a todos ellos por su trabajo y su trato.', 'faly-zarza.jpg'),
  review('soledad-parra-serradilla', 'soledad parra serradilla', 'Hace 10 meses', 'Hace apenas 15 días me han hecho una reforma en el baño, no puedo estar más contenta. Empresa sería y formal que en tiempo record, me realizaron la obra porque apenas tenía una semana de vacaciones. Desde Lucía, cara al publico, Loren y Julián con su ayudante, auténticos profesionales. De 10!!!', 'soledad-parra-serradilla.jpg'),
  review('raul-parra', 'Raul Parra', 'Hace 11 meses', 'Increible a dia de hoy encontrar a una empresa de reformas tan seria, tan amables y tan profesionales como ellos. Lucia un encanto y nos ayudo en todo, Loren, un profesional como pocos y Rober esta encima de todo y no se le escapa nada, 100% recomendables.', 'raul-parra.jpg'),
  review('virginia-donoso-montesinos', 'Virginia Donoso montesinos', 'Hace 2 años', 'Me realizaron un cuarto de baño y la obra no pudo ser mejor, personal muy profesional y amable. La chica de la tienda (lucia) no pudo asesorarme mejor, fue una gran ayuda. El cuarto de baño quedo impoluto y muy bonito. Contare con ellos sin duda de nuevo.', 'virginia-donoso-montesinos.jpg'),
  review('sandra', 'sandra', 'Hace 2 años', 'Sitio de lujo muy profesional, excelente trato. Contaré con ellos más veces', 'sandra.jpg'),
  review('oscar-diaz', 'oscar diaz', 'Hace 2 años', 'muy buena actitud de cara al publico, trato amable y cordial y excelente servicio', 'oscar-diaz.jpg'),
  review('beatriz-m-b', 'Beatriz M B', 'Hace 2 años', 'Trabajan muy bien, lo recomiendo', 'beatriz-m-b.jpg'),
  review('lucia-perez-corral', 'Lucia Perez Corral', 'Hace 2 años', 'excelente servicio', 'lucia-perez-corral.jpg'),
  review('elena-mediavilla', 'Elena Mediavilla', 'Hace un mes', 'Me hicieron una reforma general y he quedado muy contenta y satisfecha. Muy profesionales, serios, resolutivos. No dudo en contar con ellos para la próxima reforma. Un diez sin duda', 'elena-mediavilla.jpg'),
  review('maria-gemma-soriano-vazquez', 'Maria Gemma Soriano vázquez', 'Hace 4 meses', 'He hecho 2 reformas con ellos. Repito después de tantos años por su profesionalidad, amabilidad, y precio. Son sin duda mis referentes para reformas en casa. Lucia en tienda Roberto al pie de obra El equipo que tienen y su coordinación son inmejorables. Sin duda, mis referentes para teformas en casa. Un 🥇…', 'maria-gemma-soriano-vazquez.jpg'),
  review('laura-hernandez-parrado', 'Laura Hernandez Parrado', 'Hace 2 años', '', 'laura-hernandez-parrado.jpg'),
];
