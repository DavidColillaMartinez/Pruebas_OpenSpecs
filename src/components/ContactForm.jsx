    ...
    return (
      <form className="mt-16 space-y-5 border-l-2 border-clay/15 pl-5" onSubmit={handleSubmit}>
        <label className="block" htmlFor="contact-name">
          ...
          <input id="contact-name" type="text" required aria-label="Nombre" aria-required="true" placeholder="Tu nombre" value={form.nombre} onChange={(e) => setForm({ ...form, nombre: e.target.value })} className="mt-2 w-full border-b border-hairline/15 bg-transparent py-3 text-base text-primary placeholder:text-secondary/45 focus:border-hairline/40 focus:outline-none" />
        </label>
        <label className="block" htmlFor="contact-phone">
          ...
          <input id="contact-phone" type="tel" required aria-label="Teléfono" aria-required="true" placeholder="6XX XX XX XX" value={form.telefono} onChange={(e) => setForm({ ...form, telefono: e.target.value })} className="mt-2 w-full border-b border-hairline/15 bg-transparent py-3 text-base text-primary placeholder:text-secondary/45 focus:border-hairline/40 focus:outline-none" />
        </label>
  ...
  return (
    <form className="mt-7 space-y-4" onSubmit={handleSubmit}>
      <label className="block" htmlFor="contact-name-card">
        <span className="text-xs font-semibold uppercase tracking-[0.18em] text-clay">Nombre</span>
        <input id="contact-name-card" type="text" required aria-label="Nombre" aria-required="true" placeholder="Tu nombre" value={form.nombre} onChange={(e) => setForm({ ...form, nombre: e.target.value })} className="mt-2 w-full rounded-2xl border border-hairline/10 bg-surface-elevated/75 px-5 py-3.5 text-primary placeholder:text-secondary/45 focus:border-hairline/30 focus:outline-none focus:ring-2 focus:ring-clay/20" />
      </label>
      <label className="block" htmlFor="contact-phone-card">
        <span className="text-xs font-semibold uppercase tracking-[0.18em] text-clay">Teléfono</span>
        <input id="contact-phone-card" type="tel" required aria-label="Teléfono" aria-required="true" placeholder="6XX XX XX XX" value={form.telefono} onChange={(e) => setForm({ ...form, telefono: e.target.value })} className="mt-2 w-full rounded-2xl border border-hairline/10 bg-surface-elevated/75 px-5 py-3.5 text-primary placeholder:text-secondary/45 focus:border-hairline/30 focus:outline-none focus:ring-2 focus:ring-clay/20" />
      </label>
