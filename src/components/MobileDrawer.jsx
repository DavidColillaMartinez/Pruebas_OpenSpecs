    ...
    <>
      ...
      <div ref={panelRef} className="relative z-50 mx-auto mt-3 max-w-7xl rounded-[2rem] border border-ink/8 bg-white p-6 shadow-lift" role="dialog" aria-modal="true" aria-label="Menú de navegación">
        ...
        <div className="mt-5 flex flex-col gap-3 border-t border-ink/8 pt-5">
          <Link to="/productos" onMouseEnter={prefetchCatalogFirstPage} onFocus={prefetchCatalogFirstPage} className="inline-flex min-h-[44px] items-center justify-center rounded-full border border-ink/15 bg-white px-5 py-3 text-sm font-semibold text-ink shadow-soft transition hover:-translate-y-0.5 hover:border-ink/35 hover:shadow-lift focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-clay focus-visible:ring-offset-2" onClick={onClose}>Tienda</Link>
